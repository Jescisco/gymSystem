...
<div >
    <table border="1" class="tabla">
        ...
        <?php
            ...
            $buscar=htmlentities(addslashes($_GET["cedula"]));
            $connection = mysqli_connect($host, $user, $pass, $db);
            $sql= "SELECT id, nombre, apellido, cedula, telefono, ingreso FROM datos WHERE cedula LIKE '$buscar' '%' order by id";
            ...
            <td>
                ...
                ingreso=<?php echo $mostrar['5'] ?> 
                ">Editar</a>

            </td>
            <td><a href="eliminar.php? id=<?php echo $mostrar['0'] ?>">Eliminar</a></td>
            </tr>
            <?php
            }
            ?>
